import { medicalBenefitSpec } from '../config/medical-benefits.js';
import type {
...
import type { DocumentBenefit } from './plan-document.js';
import { CORE_BENEFIT_ORDER } from './plan-presentation.js';
 ...
 * is read for them — in the browser for the page, on the API for the email.
 *
...
): Omit<PlanDocumentSource, 'description'> {
