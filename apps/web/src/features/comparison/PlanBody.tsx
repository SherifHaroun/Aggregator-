...
import { Button, Card, CardBody, IconCheck, IconDownload } from '@/components/ui';
...
import type { usePlanDocumentSource } from './usePlanDocument';

/**
 * ONE PLAN, IN FULL — the body both sites share.
 *
 * The employee's plan page and the customer's plan page show exactly the
 * same thing: the figures, every age band, the six core areas with their
 * share of the bill drawn, the additional benefits, the small print, and
 * the PDF. Only what surrounds it differs — whose cart the button above
 * adds to — so the body lives here and each page wraps it.
 */
