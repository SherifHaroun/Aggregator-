...
/**
 * Customers and their carts — THE BROKER'S RECORDS, staff only.
 *
 * A customer record is the broker's, and the public site has no business
 * reading who rang in. The site writes to these records in exactly one way,
 * through `/leads`: a visitor who leaves their details is written down here
 * as a customer, and a plan they choose lands in this cart.
 */
